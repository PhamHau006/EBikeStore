      ...
      <div class="p-4">
        ...
        <div class="bg-[#2C2C2E] rounded-xl p-4 mb-4">
          ...
          <ion-radio-group v-model="paymentMethod">
            <ion-item class="mb-2 rounded-lg bg-[#3C3C3E]" lines="none">
              <ion-label class="text-white ml-2">Thẻ tín dụng</ion-label>
              <ion-radio slot="start" value="credit" />
            </ion-item>
            <ion-item class="mb-2 rounded-lg bg-[#3C3C3E]" lines="none">
              <div class="flex items-center w-full">
                <ion-label class="text-white ml-2">Vietcombank</ion-label>
                <img 
                  src="/vcb.png" 
                  alt="Vietcombank"
                  class="w-7 h-7 ml-2"
              ...
              <ion-radio slot="start" value="vcb" />
            </ion-item>
            <ion-item class="rounded-lg bg-[#3C3C3E]" lines="none">
              <ion-label class="text-white ml-2">Tiền mặt</ion-label>
        ...
        <div class="bg-[#2C2C2E] rounded-xl p-4">
          ...
          <div class="p-4">
            ...
            <a 
              v-if="paymentMethod === 'vcb'"
              :href="generateVietQRLink()"
              class="block w-full bg-[#0A84FF] text-white text-center py-3 rounded-lg h-12 flex items-center justify-center"
              target="_blank"
            >
...
const generateVietQRLink = () => {
  ...
  console.log('Generating VietQR link. Final amount:', `https://dl.vietqr.io/pay?app=vcb&ba=1017044309@vcb&am=${finalAmount}&tn=Thanh toan DH123`)
  return `https://dl.vietqr.io/pay?app=vcb&ba=1017044309@vcb&am=${finalAmount}&tn=Thanh toan DH123`
}
